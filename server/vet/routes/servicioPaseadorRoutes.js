...
export default function servicioPaseadorRoutes(getController) {
    ...
    router.post("/petcare/servicioPaseadores", authMiddleware, authorizationMiddleware('paseador'), requireMpConectado, validate(servicioPaseadorSchema), (req, res, next) => {
    ...
    router.post("/petcare/serviciosPaseadores/array", authMiddleware, authorizationMiddleware('paseador'), requireMpConectado, (req, res, next) => {
