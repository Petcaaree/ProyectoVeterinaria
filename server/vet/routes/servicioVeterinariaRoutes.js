...
export default function servicioVeterinariaRoutes(getController) {
    ...
    router.get("/petcare/serviciosVet", validate(paginationSchema, 'query'), (req, res, next) => {
    ...
    router.post("/petcare/servicioVet", authMiddleware, authorizationMiddleware('veterinaria'), requireVerificacionAprobada, requireMpConectado, validate(servicioVeterinariaSchema), (req, res, next) => {
    ...
    router.post("/petcare/serviciosVet/array", authMiddleware, authorizationMiddleware('veterinaria'), requireVerificacionAprobada, requireMpConectado, (req, res, next) => {
